...
def PARAM_COUNT (dim_emb, vocab_size, num_blocks):
    ...
    #Número Total de Parâmetros por Head
    ...
    print (f"Número de Parâmetros Non-Embedding -> {humanize.intword((Query_Key_Value + Output_Projection + (Input_Layer + Output_Layer)) * num_blocks + Language_Modelling)}")
